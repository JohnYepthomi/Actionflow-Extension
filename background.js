...
const TabActions = {
    ...
    selectTab: async function(tabInfo) {
        ...
        /*When closing a tab, chrome immediately selects next avaiable tab,
         which means there will be two msgs sent out within the same millisecond
         From what i've observed, Reactflow cannothandle such quick updates
         on receving the msgs on the frontend, it only registers the last of
         the two msgs.So, we're intentionally delaying message when a tab
         is selected*/
